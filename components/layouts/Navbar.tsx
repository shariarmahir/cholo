    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-blue-100 shadow-sm">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <Button
                  ...
                  className="bg-linear-to-r from-[#248efb] to-[#1a73e8] hover:from-[#1a73e8] hover:to-[#1557b0] text-white border-0 rounded-lg px-4 py-2 h-9 text-sm shadow-sm hover:shadow transition-all duration-200"
                >
          ...
          {/* Blue Divider Line */}
          <div className="h-px bg-linear-to-r from-transparent via-[#248efb]/50 to-transparent w-full"></div>
      ...
      <AuthDialog
        ...
        description="Join Cholo and unlock exclusive travel experiences"
      >
        <SignupForm 
